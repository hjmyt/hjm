...
const BOND_RULES = Object.freeze({ hidden: 35, giftCost: 10, giftGain: 1, giftsPerDay: 3, dailyCompanion: 1 });
...
function bondSummary(id) { const n = cardBond(id); return `<p class="stat-caption">演奏音符加成：编队与技能合计最多 +2，仅限每日前 3 场完整达标演奏。</p><p class="stat-caption">羁绊分 ${n} · ${n < 35 ? '距离隐藏技能门槛还差 ' + (35 - n) + ' 分' : '已达到隐藏技能 35 分门槛'}<br>正传与卡册共用；投喂 10 音符 / +1 分，每天最多 3 次；聊天、演奏等陪伴每日合计最多 +1 分。关键剧情可额外 +5，重玩不重复。</p>`; }

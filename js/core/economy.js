...
const ECONOMY_HELP = '音符全局共用。普通练琴 10 音符 → 琴技 +2；周训练报名 10 音符，60 分完成 +2 / 90 分 +3，失败免费重试，每章每项一次；普通投喂 10 音符 → 羁绊分 +1，每日三次；满心礼盒 10000 音符 → 羁绊直达 100，不占用、不受每日三次限制。完整演奏达到 C（45%）才获得音符：C/B/A/S 为 3/4/5/6，编队与技能合计最多另 +2；每天前 3 场达标正常奖励，之后每场总共 1 音符。演奏免费，未达标不扣音符。';

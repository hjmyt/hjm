...
function createChronicleChaptersFour(ctx) {
    ...
    function fourthHelp() { return `<p>${ECONOMY_HELP}</p><div class="cp-rule-table"><strong>剧场冲刺</strong><span>6月7日，鹭湖剧院。走过大羊的 SOLO、宝石与飞鸿的和声、柒柒的赞助提案。读到人物时立即获得卡片。</span><strong>排练间隙</strong><span>独奏安排在第 4 周；借款与练嗓按剧情进度开放为可选相遇，自由合练进入首席考核。借款需要至少 20 音符；普通借款或投喂不会触发人物线结局；选择接受出国邀请才会结束本章人物线。</span><strong>6.7 剧场之夜</strong><span>第 6 周可登台，琴技至少 15。五段演奏，每段 PERFECT +10、GOOD +6、区外 +2。难度为 15 + 登台周数；支持小周独奏 −2，扩展大羊 SOLO −1。演奏分数、声部安排与本章关系事件共同影响结局。</span><strong>承接与重选</strong><span>完成第三章后解锁，自动承接前章成长和已发生事件。六章分别保存；重开第四章恢复入口快照，保留其他章节、人物和回忆。原有隐藏档案仍需满足条件后主动展开。</span></div>`; }
